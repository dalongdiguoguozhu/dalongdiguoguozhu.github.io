<template>
	<view class="wrap">
		<view style="display: flex;flex-direction: row;padding: 30rpx 10rpx;align-items: center;background-color: #FFFFFF;">
			<text class="cuIcon-back_android " style="position: fixed;z-index:999;font-size: large;margin: 20rpx 0 10rpx 30rpx ;" @click="toaddress()"></text>
			<h3 style="margin-left: 300rpx;">添加收货地址</h3>
		</view>
		<view class="top">
			<view class="item">
		...
		<view class="bottom">
			...
			<view class="default">
				...
				<view class="right"><switch color="#FED71A" @change="setDefault" /></view>
			</view>
		</view>
